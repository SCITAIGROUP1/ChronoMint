    ...
    <div className={cn("relative", className)} ref={menuRef}>
      ...
      {open ? (
        <div
          role="menu"
          aria-label="Notifications"
          className="fixed left-4 right-4 top-16 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:w-[22rem] z-[60] mt-1.5 overflow-hidden rounded-xl border border-border/80 bg-card shadow-lg animate-in fade-in slide-in-from-top-1 duration-150"
        >
