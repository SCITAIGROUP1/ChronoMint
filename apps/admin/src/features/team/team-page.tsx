...
import { Badge, Card, CardContent, CardHeader, CardTitle, PageHeader } from "@chronomint/ui";
...
export function TeamPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Team live" description="Members currently running a stopwatch." />
      <Card>
        <CardHeader>
