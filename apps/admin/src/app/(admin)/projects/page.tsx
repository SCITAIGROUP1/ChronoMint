...
export default function AdminProjectsPage() {
  ...
  async function refreshTeam() {
    ...
    setTeam(await api<TeamDto>(ROUTES.PROJECTS.TEAM(selectedId), { workspaceId: ws }));
  }
    ...
    <div className="space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Workspace → Project → Team → Members. Create a project, then invite people onto its
          team.
        </p>
      </div>
