        ...
        <div className="flex items-center gap-3 rounded-lg border border-border bg-muted/30 px-4 py-2.5">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-0.5 text-xs">
            ...
            <span className="text-muted-foreground">
              <span className="font-medium text-foreground">{formatHours(yesterday.totalSec)}</span> logged
            </span>
            ...
            <div className="flex flex-col gap-2">
              {favorites.map((f) => (
                ...
                >
                  ...
                  <span className="truncate max-w-[120px] font-medium mr-1.5">{f.projectName}</span>
            ...
            <div className="flex flex-col gap-2">
              {recents.map((r) => (
                ...
                >
                  ...
                  <span className="truncate max-w-[120px] font-medium mr-1.5">{r.projectName}</span>
