...
const PERSONAL_DEFAULT_LAYOUT: WidgetLayoutItem[] = [
  { i: "personal_today", x: 0, y: 0, w: 2, h: 1, visible: true },
  { i: "personal_recent_hours", x: 2, y: 0, w: 2, h: 1, visible: true },
  { i: "personal_assigned_projects", x: 4, y: 0, w: 2, h: 1, visible: true },
  { i: "personal_timesheets_action", x: 6, y: 0, w: 2, h: 1, visible: true },
...
const MANAGEMENT_DEFAULT_LAYOUT: WidgetLayoutItem[] = [
  { i: "stat_total_hours", x: 0, y: 0, w: 3, h: 1, visible: true },
  { i: "stat_projects", x: 3, y: 0, w: 3, h: 1, visible: true },
  { i: "stat_members", x: 6, y: 0, w: 3, h: 1, visible: true },
  { i: "stat_billable", x: 9, y: 0, w: 3, h: 1, visible: true },
  { i: "stat_nonbillable", x: 0, y: 1, w: 3, h: 1, visible: false },
  { i: "stat_revenue", x: 3, y: 18, w: 3, h: 1, visible: false },
  { i: "daily_chart", x: 0, y: 1, w: 7, h: 5, visible: true },
  { i: "team_utilization", x: 7, y: 1, w: 5, h: 5, visible: true },
  ...
  { i: "active_timers", x: 0, y: 20, w: 3, h: 1, visible: false },
