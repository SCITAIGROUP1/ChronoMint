...
} from "./time-tracker-entry-list-item";
...
/** Personal My time week list — day tabs with hours (old client Harvest-style layout). */
    ...
    return (
      <Card className="border-primary/10 shadow-sm">
        <CardContent className="py-12">
          <EmptyState
            title="No time entries"
            description="No entries match your filters for this period. Add an entry or adjust filters."
          />
        </CardContent>
      </Card>
    );
