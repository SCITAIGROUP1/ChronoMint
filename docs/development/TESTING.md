...
The product Playwright suite lives in `apps/client/e2e` and runs against product port 3000 with
...
4. `e2e`: migrate, seed, start API and `apps/client`, then run Playwright persona journeys.
