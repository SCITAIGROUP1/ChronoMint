...
4. The member opens the link in the unified product, signs in, and accepts.
...
On **Project → Settings**, enable timesheet approval and choose daily, weekly, or monthly period
(or use the workspace default). Members submit from **Submissions** in the same product; authorized
project managers or workspace admins review on **Approvals** (`/approvals`).
