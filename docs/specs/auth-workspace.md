...
- Unified product (`apps/client`): `/login`, `/signup`, `/select-context`, `/select-workspace`
- Workspace management:
  [apps/client/src/app/(app)/workspace/page.tsx](<../../apps/client/src/app/(app)/workspace/page.tsx>)
